...
constexpr const char *PUMP_SETTINGS_API = "/api/pump-settings";   ///< Telemetry endpoint
constexpr const char *PUMP_BY_ID_API = "/api/pump-settings/getById"; ///< Settings query endpoint
constexpr const char *DOSE_LOG_API = "/api/dose-history";         ///< Dose logging endpoint
