...
public:
  ...
  /// @brief Save speed profiles to EEPROM
...
private:
  ...
  /// @brief Enable the stepper driver (pull EN pin LOW)
  void enablePump();
  /// @brief Disable the stepper driver (pull EN pin HIGH)
  void disablePump();
  /// @brief Track position changes for movement timeout detection
